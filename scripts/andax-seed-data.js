// Datos semilla ANDAX — copiados de lib/demo-data.ts.
// Generado para el script wipe-and-seed-andax.js.
const ml = (id) => `https://http2.mlstatic.com/${id}`;
...
module.exports.DEMO_REVIEWS = [
  { id: "rev-001", product_slug: "creatina-star-nutrition-300g", nombre: "Martin G.", email: "martin@example.com", calificacion: 5, titulo: "Lo que me faltaba en el gym", contenido: "La tomo hace 2 meses y se nota la diferencia. Mas repeticiones, mejor recuperacion. Llego en 48h como decia. Recomendadisimo.", fecha: "2026-04-05", aprobado: "si", verificado: true, destacada: true },
  { id: "rev-002", product_slug: "magnesio-bisglicinato-120caps", nombre: "Florencia B.", email: "flor@example.com", calificacion: 5, titulo: "Por fin duermo bien", contenido: "Probe mil marcas y esta es la unica que funciona de verdad. Duermo de corrido y me levanto descansada. Mi nuevo imprescindible.", fecha: "2026-04-07", aprobado: "si", verificado: true, destacada: true },
  { id: "rev-003", product_slug: "colageno-hidrolizado-ena-345g", nombre: "Laura M.", email: "laura@example.com", calificacion: 5, titulo: "Mi piel cambio", contenido: "A los 35 empece a notar cosas que no me gustaban. Llevo 3 meses y mi piel esta mucho mejor. Sin sabor, lo pongo en el cafe y listo.", fecha: "2026-04-02", aprobado: "si", verificado: true, destacada: true },
  { id: "rev-004", product_slug: "whey-protein-ena-chocolate-930g", nombre: "Nicolas R.", email: "nico@example.com", calificacion: 4, titulo: "Muy buena proteina", contenido: "Se disuelve perfecto, sabor no es empalagoso. Me dura mas de un mes. La relacion precio-calidad esta muy bien.", fecha: "2026-04-09", aprobado: "si", verificado: true, destacada: false },
  { id: "rev-005", product_slug: "vitamina-d3-k2-omega3-gotas", nombre: "Sofia T.", email: "sofi@example.com", calificacion: 5, titulo: "Energia todo el dia", contenido: "Empece a tomarlo hace 3 semanas y la diferencia de energia es notable. Mas ganas, mejor animo. Lo vuelvo a pedir.", fecha: "2026-04-10", aprobado: "si", verificado: true, destacada: true },
  { id: "rev-006", product_slug: "pre-entreno-unipro-300g", nombre: "Diego A.", email: "diego@example.com", calificacion: 5, titulo: "Explota cada sesion", contenido: "Sabor frutos rojos espectacular, el pump es brutal y no tiene crash. Para mi el mejor preworkout que probe hasta ahora.", fecha: "2026-04-08", aprobado: "si", verificado: true, destacada: false },
];
